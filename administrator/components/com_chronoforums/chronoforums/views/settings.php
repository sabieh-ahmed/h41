...
<div class="container">
	<div class="row" style="margin-top:20px;">
		<?php echo \GCore\Admin\Extensions\Chronoforums\Helpers\Menu::render(); ?>
	</div>
	<div class="row" style="margin-top:20px;">
		<div class="col-md-6">
			...
			<form action="<?php echo r_('index.php?ext=chronoforums&act=save_settings'); ?>" method="post" name="admin_form" id="admin_form">	
				<div id="details-panel">
					...
					<div id="general" class="tab-pane active">
						...
						<?php echo $this->Html->formLine('Chronoforums[board_message]', array('type' => 'textarea', 'label' => l_('BOARD_MESSAGE'), 'value' => '', 'rows' => 3, 'cols' => 80, 'sublabel' => l_('BOARD_MESSAGE_DESC'))); ?>
						...
						<?php echo $this->Html->formLine('Chronoforums[offline_message]', array('type' => 'textarea', 'label' => l_('OFFLINE_MESSAGE'), 'value' => 'Our board is currently offline, please check back again in the next few hours.', 'rows' => 3, 'cols' => 80)); ?>
						...
						<?php echo $this->Html->formLine('Chronoforums[board_display]', array('type' => 'dropdown', 'label' => l_('BOARD_DISPLAY'), 'options' => array('default' => l_('CFU_DEFAULT_CATEGORIZED'), 'discussions' => l_('DISCUSSIONS')), 'sublabel' => l_('BOARD_DISPLAY_DESC'))); ?>
						...
						<?php echo $this->Html->formLine('Chronoforums[attachment_max_size]', array('type' => 'text', 'label' => l_('ATTACHMENT_MAX_SIZE'), 'value' => '1000', 'class' => 'S', 'sublabel' => l_('ATTACHMENT_MAX_SIZE_DESC'))); ?>
						...
						<?php echo $this->Html->formLine('Chronoforums[auto_login_redirect]', array('type' => 'dropdown', 'label' => l_('AUTO_LOGIN_REDIRECT'), 'values' => 0, 'options' => array(0 => l_('NO'), 1 => l_('YES')), 'sublabel' => l_('AUTO_LOGIN_REDIRECT_DESC'))); ?>
						<?php echo $this->Html->formLine('Chronoforums[enable_smilies]', array('type' => 'dropdown', 'label' => l_('ENABLE_SMILIES'), 'values' => 1, 'options' => array(0 => l_('NO'), 1 => l_('YES')), 'sublabel' => l_('ENABLE_SMILIES_DESC'))); ?>
						<?php echo $this->Html->formLine('Chronoforums[enable_private_data]', array('type' => 'dropdown', 'label' => l_('ENABLE_PRIVATE_DATA'), 'values' => 0, 'options' => array(0 => l_('NO'), 1 => l_('YES')), 'sublabel' => l_('ENABLE_PRIVATE_DATA_DESC'))); ?>
						<?php echo $this->Html->formLine('Chronoforums[enable_tooltips]', array('type' => 'dropdown', 'label' => l_('ENABLE_TOOLTIPS'), 'values' => 1, 'options' => array(0 => l_('NO'), 1 => l_('YES')), 'sublabel' => l_('ENABLE_TOOLTIPS_DESC'))); ?>
					...
					<div id="display" class="tab-pane">
						...
						<?php echo $this->Html->formLine('Chronoforums[reply_textarea_rows]', array('type' => 'text', 'label' => l_('REPLY_TEXTAREA_ROWS'), 'value' => 10, 'sublabel' => l_('REPLY_TEXTAREA_ROWS_DESC'))); ?>
						<?php echo $this->Html->formLine('Chronoforums[quickreply_textarea_rows]', array('type' => 'text', 'label' => l_('QUICKREPLY_TEXTAREA_ROWS'), 'value' => 5, 'sublabel' => l_('QUICKREPLY_TEXTAREA_ROWS_DESC'))); ?>
						...
						<?php echo $this->Html->formLine('Chronoforums[update_emails_display]', array('type' => 'dropdown', 'label' => l_('UPDATE_EMAILS_DISPLAY'), 'values' => 1, 'options' => array(0 => l_('NO'), 1 => l_('YES')), 'sublabel' => l_('UPDATE_EMAILS_DISPLAY_DESC'))); ?>
						...
						<?php echo $this->Html->formLine('Chronoforums[enable_code_highlight]', array('type' => 'dropdown', 'label' => l_('ENABLE_CODE_HIGHLIGHT'), 'values' => 1, 'options' => array(0 => l_('NO'), 1 => l_('YES')), 'sublabel' => l_('ENABLE_CODE_HIGHLIGHT_DESC'))); ?>
					...
					<div id="authors" class="tab-pane">
						...
						<?php echo $this->Html->formLine('Chronoforums[topic_status_author]', array('type' => 'dropdown', 'label' => l_('TOPIC_STATUS_AUTHOR'), 'values' => 0, 'options' => array(0 => l_('NO'), 1 => l_('YES')), 'sublabel' => l_('TOPIC_STATUS_AUTHOR_DESC'))); ?>
					...
					<div id="notifications" class="tab-pane">
						...
						<?php echo $this->Html->formLine('Chronoforums[enable_forums_subscriptions]', array('type' => 'dropdown', 'label' => l_('ENABLE_FORUMS_SUBSCRIPTIONS'), 'values' => 0, 'options' => array(0 => l_('NO'), 1 => l_('YES')), 'sublabel' => l_('ENABLE_FORUMS_SUBSCRIPTIONS_DESC'))); ?>
						<?php echo $this->Html->formLine('Chronoforums[forums_subscriptions_groups]', array('type' => 'checkbox_group', 'label' => l_('FORUMS_SUBSCRIPTIONS_GROUPS'), 'multiple' => 'multiple', 'options' => $groups, 'ghost' => true, 'sublabel' => l_('FORUMS_SUBSCRIPTIONS_GROUPS_DESC'))); ?>
						<?php echo $this->Html->formLine('Chronoforums[forums_subscriptions_frequency]', array('type' => 'text', 'label' => l_('FORUMS_SUBSCRIPTIONS_FREQUENCY'), 'value' => '24', 'class' => 'S', 'sublabel' => l_('FORUMS_SUBSCRIPTIONS_FREQUENCY_DESC'))); ?>
						<?php echo $this->Html->formSecEnd(); ?>
						<?php echo $this->Html->formEnd(); ?>
					</div>
					<div id="email_config" class="tab-pane">
						...
						<?php echo $this->Html->formLine('Chronoforums[mail][mail_method]', array('type' => 'dropdown', 'label' => l_('MAILING_METHOD'), 'values' => (!empty($this->data['Chronoforums']['mail']['smtp']) ? 'smtp' : 'phpmail'), 'options' => array('phpmail' => l_('PHP Mailer'), 'sendmail' => l_('SENDMAIL'), 'smtp' => l_('SMTP')))); ?>
					...
					<div id="messages" class="tab-pane">
						...
						<?php echo $this->Html->formLine('Chronoforums[pm_recipients_filters]', array('type' => 'dropdown', 'label' => l_('MESSAGES_RECIPIENTS_FILTER'), 'values' => 'username', 'options' => array('username' => l_('USERNAMES'), 'name' => l_('NAMES'), 'both' => l_('USERNAMES_NAMES')), 'sublabel' => l_('MESSAGES_RECIPIENTS_FILTER_DESC'))); ?>
						<?php echo $this->Html->formSecEnd(); ?>
						<?php echo $this->Html->formEnd(); ?>
					</div>
