...
<?php
	...
	$this->Toolbar->addButton('locale', r_('index.php?ext=chronoforums&act=install_locale'), l_('CFU_INSTALL_LOCALE'), \GCore\C::get('GCORE_ADMIN_URL').'extensions/chronoforums/assets/images/locale.png');
