...
class Lang{
	...
	const FORUM_PERMISSIONS = "Dedicated permissions";
	const FORUM_PERMISSIONS_DESC = "Enable the per category/forum permissions, You must enable and configure the permissions under any of your forums in order for this setting to take effect, otherwise the global permissions apply.";
	...
	const CFU_DEFAULT_CATEGORIZED = "Default (Categorized)";
	...
	const REPLY_TEXTAREA_ROWS = "Reply textarea rows";
	const REPLY_TEXTAREA_ROWS_DESC = "The rows attribute value for the main reply textarea.";
	const QUICKREPLY_TEXTAREA_ROWS = "Quick reply rows";
	const QUICKREPLY_TEXTAREA_ROWS_DESC = "The rows attribute value for the quick reply textarea.";
	const TOPIC_STATUS_AUTHOR = "Topic status author";
	const TOPIC_STATUS_AUTHOR_DESC = "Display the topic's author username in the topic's status top bar.";
	const ENABLE_SMILIES = "Enable smileys";
	const ENABLE_SMILIES_DESC = "Enable smileys support on the forums.";
	const MESSAGES_RECIPIENTS_FILTER = "Recipients search filter";
	const MESSAGES_RECIPIENTS_FILTER_DESC = "Search users by either username or name or both.";
	const USERNAMES = "Usernames";
	const NAMES = "Names";
	const USERNAMES_NAMES = "Both usernames & names";
	const ENABLE_FORUMS_SUBSCRIPTIONS = "Enable forums subscriptions";
	const ENABLE_FORUMS_SUBSCRIPTIONS_DESC = "Send periodic notifications to board members about the latest forums activity.";
	const FORUMS_SUBSCRIPTIONS_GROUPS = "Forums subscriptions groups";
	const FORUMS_SUBSCRIPTIONS_GROUPS_DESC = "Users groups allowed to receive the forums notifications.";
	const FORUMS_SUBSCRIPTIONS_FREQUENCY = "Forums subscriptions frequency";
	const FORUMS_SUBSCRIPTIONS_FREQUENCY_DESC = "The time between forums notifications emails in hours";
	const MAILING_METHOD = "Mailing method";
	const PERMS_CREATE_TOPICS = "Create New Topics";
	const PERMS_VIEW_TOPICS = "Read/View Topics";
	const PERMS_REPLY = "Post Replies";
	const PERMS_MODIFY_TOPICS = "Moderator (Modify/Delete Topics & Authors)";
	const PERMS_VIEW_ATTACH = "See posts attachments";
	const PERMS_DOWNLOAD_ATTACHMENTS = "Download and see inline attachments";
	const PERMS_ATTACH = "Attach Files";
	const PERMS_EDIT_POSTS = "Edit Posts";
	const PERMS_DELETE_POSTS = "Delete Posts";
	const PERMS_REPORT_POSTS = "Report Posts";
	const PERMS_VIEW_REPORTS = "View Reports";
	const PERMS_SELECT_ANSWER = "Select Answers";
	const PERMS_FEATURE = "Feature Topics";
	const PERMS_VOTE = "Vote";
	const PERMS_VIEW_PRIVATE = "View private content";
	const PERMS_DISPLAY_ACCESS = "Display/Access the forums";
	const ENABLE_PERMISSIONS = "Enable permissions";
	const ENABLE_PERMISSIONS_DESC = "Activate the permissions of this forum, if disabled then the global permissions apply.";
	const ENABLE_CODE_HIGHLIGHT = "Highlight code";
	const ENABLE_CODE_HIGHLIGHT_DESC = "Enable syntax highlight for code inside code blocks.";
	const AUTO_LOGIN_REDIRECT = "Auto login redirect";
	const AUTO_LOGIN_REDIRECT_DESC = "Redirect the user to the Login screen when they don't have enough permissions to access some resource.";
	const ATTACHMENT_MAX_SIZE = "Maximum attachment size";
	const ATTACHMENT_MAX_SIZE_DESC = "The maximum attachment file size allowed on board (in KB).";
	const BOARD_MESSAGE = "Board message";
	const BOARD_MESSAGE_DESC = "A message to be displayed above your board.";
	const ENABLE_TOOLTIPS = "Enable tooltips";
	const ENABLE_TOOLTIPS_DESC = "Enable tooltips on your board.";
	const ENABLE_PRIVATE_DATA = "Private data";
	const ENABLE_PRIVATE_DATA_DESC = "Enable private data support in the editor, users can enclose any data in private tags and only permitted users can view it.";
	const UPDATE_EMAILS_DISPLAY = "Update Emails";
	const UPDATE_EMAILS_DISPLAY_DESC = "Update email addresses used in the posts text to protect them from spam spiders.";
	
	const CFU_SELECT_LOCALE_FILE = "Select language file";
	const CFU_SELECT_LOCALE_FILE_DESC = "The language file should be .zip, and should include the language folder, e.g: en_gb";
	const CFU_SELECT_LOCALE_TARGET = "Area";
	const CFU_SELECT_LOCALE_TARGET_DESC = "The language file area.";
	const CFU_SELECT_LOCALE_TARGET_ADMIN = "Admin";
	const CFU_SELECT_LOCALE_TARGET_FRONT = "Front";
	const CFU_INSTALL_LOCALE_TITLE = "Install Chronoforums language file";
	const CFU_INSTALL_LOCALE = "Install language";
	const CFU_LOCALE_UPLOAD_ERROR = "Upload error, couldn't upload the language file.";
	const CFU_LOCALE_EXTRACT_ERROR = "Extract error, couldn't extract the language file.";
	const CFU_LOCALE_FILE_ERROR = "File error, the uploaded file may not be a Chronoforums language file.";
	const CFU_LOCALE_INSTALL_SUCCESS = "Languages installed successfuly.";
}