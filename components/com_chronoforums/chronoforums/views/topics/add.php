...
<div class="chronoforums topics add">
	<div class="container">
		...
		<div class="row cfu-body">
			<h3><?php echo l_('CHRONOFORUMS_ADD_TOPIC_HEADER'); ?></h3>
			<p><?php echo l_('CHRONOFORUMS_ADD_TOPIC_INFO'); ?></p>
			<form action="<?php echo r_('index.php?ext=chronoforums&cont=topics&act=add&f='.\GCore\Libs\Request::data('f')); ?>" method="post" name="postform" enctype="multipart/form-data" id="postform" class="panel">
				...
				<?php endif; ?>
				<?php if($fparams->get('board_display', 'default') == 'discussions' OR !\GCore\Libs\Request::data('f')): ?>
					<?php ob_start(); ?>
