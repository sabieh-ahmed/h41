		...
		<div class="row cfu-details">
			<div class="panel panel-info">
				<div class="panel-heading">
					<a title="<?php echo l_('CHRONOFORUMS_POST_REPLY'); ?>" class="btn btn-primary btn-xs cfu-btn-reply gcoreTooltip" href="<?php echo r_('index.php?ext=chronoforums&cont=messages&act=compose&m='.$message['Message']['id'].'&u='.$u.'&d='.$d.'&subject='.urlencode($message['Message']['subject'])); ?>"><i class="fa fa-fw fa-2x fa-reply"></i><?php //echo l_('CHRONOFORUMS_REPLY'); ?></a>
