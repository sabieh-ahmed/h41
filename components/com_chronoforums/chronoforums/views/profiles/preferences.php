...
<div class="chronoforums profiles edit">
	<div class="container">
		...
		<div class="row cfu-body">
			<h3><?php echo l_('CHRONOFORUMS_BOARD_PREFERENCES_HEADER'); ?></h3>
			<p><?php echo l_('CHRONOFORUMS_BOARD_PREFERENCES_INFO'); ?></p>
			<form action="<?php echo r_('index.php?ext=chronoforums&cont=profiles&act=preferences&u='.$user['User']['id']); ?>" method="post" name="postform" id="postform">
